...
import Krishna from '../images/krish.jpg'; 
import Pushpendra from '../images/Pushpendra.jpg'; 
import Shubham from '../images/Shubham.jpg';// Updated import statement
        ...
        <div className="min-h-screen bg-black text-white overflow-hidden">
            ...
            <section className="container mx-auto px-6 py-16 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                    {[
                        { name: "Anish", image: anish, title: "" },
                        { name: "Ashok", image: ashok, title: "" },
                        { name: "Krishna", image: Krishna, title: "" },
                        { name: "Pushpendra", image: Pushpendra, title: "" },
                        { name: "Shubham", image: Shubham, title: "" },
                    ].map((team, index) => (
                        <div key={index} className="p-0.5 rounded-2xl border border-gray-700">
